...
function iniciarApp(){
    ...
    tabs(); //Cambia la sección cuando se precionen los tabs
    botonesPaginador(); //Agrega o quita los botones del paginador
    paginaSiguiente();
    paginaAnterior();

    consultarAPI(); //Consulta la API en el backend en el API de PHP
...
async function reservarCita() {
    const { fecha, hora, servicios, usuarioId } = cita;
